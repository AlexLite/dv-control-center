exports.getVariables = function () {
	...
	var variables = [
		...
		{
			label: 'DVCC Merge Active Flex Key',
			name: 'dvcc_merge_active_flex'
		},
		{
			label: 'DVCC Merge Running Flex Key',
			name: 'dvcc_merge_running_flex'
		},
		{
			label: 'DVCC Merge Active PIP Key',
			name: 'dvcc_merge_active_pip'
		},
		{
			label: 'DVCC Merge Running PIP Key',
			name: 'dvcc_merge_running_pip'
		},
	];
