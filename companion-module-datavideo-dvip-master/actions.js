exports.getActions = function () {
	...
	let actions = {};
	const isSE3200FlexVirtual = this.config.modelID == 'se3200' && !this.model.legacy_dvip;
	const switchPgmChoices = isSE3200FlexVirtual
		? this.model.pgm.concat([
			{ id: 'dv_virtual_flex1', label: 'Flex1 (Run + Flex)' },
			{ id: 'dv_virtual_flex2', label: 'Flex2 (Run + Flex)' },
		])
		: this.model.pgm;
	const switchPvwChoices = isSE3200FlexVirtual
		? this.model.pvw.concat([
			{ id: 'dv_virtual_flex1', label: 'Flex1 (Run + Flex)' },
			{ id: 'dv_virtual_flex2', label: 'Flex2 (Run + Flex)' },
		])
		: this.model.pvw;
